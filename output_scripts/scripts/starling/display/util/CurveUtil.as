package starling.display.util
{
   ...
   public class CurveUtil
   {
      ...
      public static function calculateElipsePoint(param1:Number, param2:Number, param3:Number, param4:Point) : void
      {
         ...
         param4.y = starling.display.util.CurveUtil.calculateElipseY(param1,param2,param4.x);
      }
      ...
      private static function quadratic(param1:Number, param2:int) : Number
      {
         ...
         var _loc4_:Number = _terms[0 + param2];
         var _loc5_:Number = _terms[2 + param2];
         var _loc6_:Number = _terms[4 + param2];
         return _loc3_ * _loc3_ * _loc4_ + 2 * _loc3_ * param1 * _loc5_ + param1 * param1 * _loc6_;
      }
      ...
      private static function cubic(param1:Number, param2:int) : Number
      {
         ...
         return _loc3_ * _loc3_ * _loc3_ * _loc4_ + 3 * _loc3_ * _loc3_ * param1 * _loc5_ + 3 * _loc3_ * param1 * param1 * _loc6_ + param1 * param1 * param1 * _loc7_;
      }
      
      private static function subdivide(param1:Number, param2:Number, param3:int, param4:Function, param5:Vector.<Number>) : void
      {
         var _loc6_:Number = param4((param1 + param2) * 0.5,0);
         var _loc7_:Number = param4((param1 + param2) * 0.5,1);
         var _loc8_:Number = param4(param1,0);
         var _loc9_:Number = param4(param1,1);
         var _loc10_:Number = param4(param2,0);
         var _loc11_:Number = param4(param2,1);
         var _loc12_:Number = (_loc8_ + _loc10_) * 0.5;
         var _loc13_:Number = (_loc9_ + _loc11_) * 0.5;
         var _loc14_:Number = _loc6_ - _loc12_;
         var _loc15_:Number = _loc7_ - _loc13_;
         var _loc16_:Number;
         if((_loc16_ = _loc14_ * _loc14_ + _loc15_ * _loc15_) > _bezierError * _bezierError)
         {
         ...
         {
            ++_subSteps;
            param5.push(_loc10_,_loc11_);
         }
      }
      
      private static function subdivideQuadratic(param1:Number, param2:Number, param3:int, param4:Vector.<Number>) : void
      {
         var _loc5_:Number = quadratic((param1 + param2) * 0.5,0);
         var _loc6_:Number = quadratic((param1 + param2) * 0.5,1);
         var _loc7_:Number = quadratic(param1,0);
         var _loc8_:Number = quadratic(param1,1);
         var _loc9_:Number = quadratic(param2,0);
         var _loc10_:Number = quadratic(param2,1);
         var _loc11_:Number = (_loc7_ + _loc9_) * 0.5;
         var _loc12_:Number = (_loc8_ + _loc10_) * 0.5;
         var _loc13_:Number = _loc5_ - _loc11_;
         var _loc14_:Number = _loc6_ - _loc12_;
         var _loc15_:Number;
         if((_loc15_ = _loc13_ * _loc13_ + _loc14_ * _loc14_) > _bezierError * _bezierError)
         {
         ...
         {
            ++_subSteps;
            param4.push(_loc9_,_loc10_);
         }
      }
      
      private static function subdivideCubic(param1:Number, param2:Number, param3:int, param4:Vector.<Number>) : void
      {
         var _loc5_:Number = cubic((param1 + param2) * 0.5,0);
         var _loc6_:Number = cubic((param1 + param2) * 0.5,1);
         var _loc7_:Number = cubic(param1,0);
         var _loc8_:Number = cubic(param1,1);
         var _loc9_:Number = cubic(param2,0);

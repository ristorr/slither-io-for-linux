      ...
      public function assemble(param1:String, param2:String, param3:uint = 1, param4:Boolean = false) : ByteArray
      {
         ...
         while(_loc10_ < _loc11_ && this._error == "")
         {
            ...
            else
            {
               ...
               else
               {
                  ...
                  if(!(_loc18_ = _loc12_.match(/vc\[([vofi][acostdip]?[d]?)(\d*)?((\.[xyzw])?(\+\d{1,3})?)?\](\.[xyzw]{1,4})?|([vofi][acostdip]?[d]?)(\d*)?(\.[xyzw]{1,4})?/gi)) || _loc18_.length != _loc17_.numRegister)
                  {
                  ...
                  {
                     _loc23_ = false;
                     if((Boolean(_loc24_ = _loc18_[_loc22_].match(/\[.*\]/ig))) && _loc24_.length > 0)
                     {
                     ...
                     if(!(_loc25_ = _loc18_[_loc22_].match(/^\b[A-Za-z]{1,3}/ig)))
                     {
         ...
         if(this.debugEnabled)
         {
            ...
            while(_loc49_ < _loc48_)
            {
               ...
               if((_loc50_ = String(this.agalcode[_loc49_].toString(16))).length < 2)
               {
                  _loc50_ = "0" + _loc50_;
               }
               _loc47_ += _loc50_;
